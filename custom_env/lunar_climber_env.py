...
class LunarLander(gym.Env, EzPickle):
    ...
    def step(self, action):
        ...
        success = pos.x > self.helipad_x1 and pos.x < self.helipad_x2
        # if self.landed:
        ...
        # This is questionable - being able to recover after landing might be useful. Makes training faster.
            ...
            x_reward = AXIS_REWARD_MAX - normalized_distance_x ** 2
            """
            if pos.x <= helipad_x:  # Climber is on the left side of helipad
                ...
                # x_reward = 0
            """
            reward += x_reward * X_REWARD_FACTOR
            ...
            y_reward = AXIS_REWARD_MAX - normalized_distance_y ** 2
            reward += y_reward * Y_REWARD_FACTOR
